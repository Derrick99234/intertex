...
export default function DeliveryOption() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center py-20 bg-primary">
      <div className="max-w-4xl w-full min-h-[120vh] mx-auto p-6 px-10 bg-white rounded-md shadow-md py-14">
